...
/**
* RTMExamples/AutoTest/_MyServiceStub.java .
* IDL-to-Java コンパイラ (ポータブル), バージョン "3.1" で生成
* 生成元: src/RTMExamples/AutoTestService.idl
* 2010年5月10日 16時54分07秒 JST
*/

public class _MyServiceStub extends org.omg.CORBA.portable.ObjectImpl implements RTMExamples.AutoTest.MyService
{
  ...
  public String[] get_echo_history ()
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                String $result[] = RTMExamples.AutoTest.EchoListHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public float[] get_value_history ()
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                float $result[] = RTMExamples.AutoTest.ValueListHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
