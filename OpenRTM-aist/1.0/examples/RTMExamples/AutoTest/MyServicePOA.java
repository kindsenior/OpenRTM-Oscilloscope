...
/**
* RTMExamples/AutoTest/MyServicePOA.java .
...
public abstract class MyServicePOA extends org.omg.PortableServer.Servant
 implements RTMExamples.AutoTest.MyServiceOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // AutoTest/MyService/echo
       {
       ...
       case 1:  // AutoTest/MyService/get_echo_history
       {
         String $result[] = null;
         $result = this.get_echo_history ();
         out = $rh.createReply();
         RTMExamples.AutoTest.EchoListHelper.write (out, $result);
         break;
       }

       case 2:  // AutoTest/MyService/set_value
       {
       ...
       case 3:  // AutoTest/MyService/get_value
       {
       ...
       case 4:  // AutoTest/MyService/get_value_history
       {
         float $result[] = null;
         $result = this.get_value_history ();
         out = $rh.createReply();
         RTMExamples.AutoTest.ValueListHelper.write (out, $result);
         break;
       }
