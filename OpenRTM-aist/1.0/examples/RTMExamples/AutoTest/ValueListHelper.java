...
/**
* RTMExamples/AutoTest/ValueListHelper.java .
...
{
  private static String  _id = "IDL:AutoTest/ValueList:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (RTMExamples.AutoTest.ValueListHelper.id (), "ValueList", __typeCode);
    }
    return __typeCode;
  }
