...
/*!
 * @class OscillatorComp
 * @brief Standalone component Class
 *
 */
public class OscillatorComp implements ModuleInitProc {
    ...
    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(Oscillator.component_conf);
      mgr.registerFactory(prop, new Oscillator(), new Oscillator());

      // Create a component
      RTObject_impl comp = mgr.createComponent("Oscillator");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        OscillatorComp init = new OscillatorComp();
